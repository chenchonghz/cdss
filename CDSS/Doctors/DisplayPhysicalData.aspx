<%@ Page Title="体温数据" Language="C#" MasterPageFile="~/Doctor.master" AutoEventWireup="true" CodeBehind="DisplayPhysicalData.aspx.cs" Inherits="CDSS.DisplayPhysicalData" %><%@ Register assembly="System.Web.DataVisualization, Version=4.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35" namespace="System.Web.UI.DataVisualization.Charting" tagprefix="asp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderDoctor" runat="server">
    <asp:Chart ID="Chart1" runat="server" DataSourceID="SqlDataSourcePhysicalData" Height="343px" style="margin-right: 0px" Width="855px">
        ...
        <Legends>  
         ...
         <Titles>  
         <asp:Title BackImageAlignment="Top" Font="微软雅黑, 16pt" Name="chartTitle" Text="近一个月的体温情况">  
         </asp:Title>  
     </Titles>   
    </asp:Chart>
    <br />
